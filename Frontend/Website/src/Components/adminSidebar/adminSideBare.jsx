        ...
        <div className='sidebar px-10 pt-8 pb-5 flex flex-col justify-between items-center'>
            <div className="top">
                ...
                <ul className='nav ml-14 md:pl-10 mt-10 flex flex-col align-center justify-center'>
                    <li className='py-1 text-sm mb-2'><NavLink style={({ isActive }) => { return isActive ? { color: primaryColor } : {}; }} to="/">
                        <div className='flex relative items-center'>
                            <TbDeviceAnalytics className='w-7 h-7 ml-1'  />
                            <span className=' absolute left-9 top-1 text ml-3'>Dashboard</span>
                        </div>
                    </NavLink>
                    </li>
                    <li className='pb-1 px-1 text-sm flex items-center mb-2 '><NavLink style={({ isActive }) => { return isActive ? { color: primaryColor } : {}; }} to="/admin">
                        <div className='flex relative items-center'>
                            
                            <IoBookSharp className='w-8 mt-3 h-6 mr-4' />
                            <span className='absolute left-9 top-3 text ml-3'>Books</span>
                        </div>
                    </NavLink>
                    </li>
                    ...
                    <li className='py-1 px-1 ml-0.5 text-sm mb-2'><NavLink style={({ isActive }) => { return isActive ? { color: primaryColor } : {}; }} to="/">
                        <div className='flex relative items-center'>
                            <TbUserSquare className='w-5 mt-3 h-5 mr-2 ml-1' />
                            <span className=' absolute left-9 top-3 text ml-3'>Users</span>
                        </div>
                    </NavLink>
                    </li>
                    ...
                    <li className='text-sm flex items-center mb-2 '><NavLink style={({ isActive }) => { return isActive ? { color: primaryColor } : {}; }} to="/">
                        <div className='flex items-center relative ' style={{ marginLeft: '-3px' }}>
                            <FiShoppingCart className='w-7 h-6 mt-3 ml-2.5 mr-1' />
                            <span className=' absolute left-11 top-4 text ml-3 '>Order</span>
                        </div>
                    </NavLink>
                    </li>
                </ul>
